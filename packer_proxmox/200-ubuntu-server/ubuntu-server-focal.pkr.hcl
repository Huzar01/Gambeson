...
source "proxmox" "ubuntu-server-focal" {
    ...
    iso_file = "NFS_DS220:iso/ubuntu-20.04.3-desktop-amd64.iso"
    ...
    # Autoinstall command is a Ubuntu feature to auto fetch the commands online 
    boot_command = [
        "<esc><wait><esc><wait>",
        "<f6><wait><esc><wait>",
        "<bs><bs><bs><bs><bs>",
